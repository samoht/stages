...
In the example of self-scaling web-servers, new created instances first fork an image of the distributed database.
Then they can modify it independently according to received requests.
Finally, then the traffic is decreasing, they have to merge their version of the database with others web-servers before shutting down.

Managing such behaviours is the purpose of distributed databases.
...
The \opam repository for mergeable queues is available at \href{https://github.com/mirage/merge-queues}{this address}.
