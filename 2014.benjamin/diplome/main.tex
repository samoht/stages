...
Finally, then the traffic is decreasing, they have to merge their version of the state with others web-servers before shutting down in order to maintain the consistency of the global state.
